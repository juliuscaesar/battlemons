 ...
 * 	- Power Points
 * 
 * A Move may or may note have:
 * 	- Status and Status Accuracy.
 * 
...
public class Move{
     ...
     * 
     * @param name
     * 		is the Move's Name. [ Listed in general.Attack ]
     * @param dmg
     * 		is the Power for this move. [ Generated by Default by the moves.MoveSet class ]
     * @param acc
     * 		is the Accuracy Rate for this Move. Values between 1 and 100. [ Generated by Default by the moves.MoveSet class ]
     * @param pp
     * 		is the Power Points for this Move, in other words, the Number of times this number can be used.
     * 		[ Generated by Default by the moves.MoveSet class ]
     * @param element
     * 		is the Move's Element. [ Listed in general.Element ]
     * @param cat
     * 		is this Move's Category. [ Listed in general.MoveCategory ]
     */
