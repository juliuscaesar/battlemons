...
public class MoveSet {
  ...
  static {
	    ...
	    AmnesiaMove.addStatus(Status.Sleep, 100);
	    BarrierMove.addStatus(Status.Burn, 100);
	    ConfuseRayMove.addStatus(Status.Sleep, 100);
	    HazeMove.addStatus(Status.Freeze, 100);
	    KinesisMove.addStatus(Status.Sleep, 100);
	    LeechSeedMove.addStatus(Status.Sleep, 100);
	    MistMove.addStatus(Status.Freeze, 100);
	    PoisonGasMove.addStatus(Status.Poison, 100);
	    SandattackMove.addStatus(Status.Burn, 100);
	    SporeMove.addStatus(Status.Paralysis, 100);
	    StringShotMove.addStatus(Status.Paralysis, 100);
	    TeleportMove.addStatus(Status.Burn, 100);
	    ThunderWaveMove.addStatus(Status.Paralysis, 100);
