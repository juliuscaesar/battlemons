...
/**
 * Monster Class. A Monster consists of: - Name (Attack) - Attributes - Its
 * Current Status. - Element1 - Element2 - List of Moves
 */
public final class Monster {
    ...
    public Monster(Monster monster) {
        ...
        this.statusStart = monster.statusStart;
        this.statusDuration = monster.statusDuration;
        this.e1 = monster.e1;
        this.moves = new HashMap<Attack, Move>(monster.moves);
        this.canMove = monster.canMove;
